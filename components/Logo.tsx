  ...
  return (
    <svg width="180" height="180" viewBox="0 0 180 180" fill="none" xmlns="http://www.w3.org/2000/svg" {...rest}>
      ...
      <g filter="url(#filter1_d_122_33)">
        ...
        <path d="M50.1309 123.5L67.6309 93L85.7283 61.5677C86.1207 60.8861 87.1099 60.9034 87.4783 61.5981L104.131 93L120.199 121.829C120.593 122.534 121.617 122.507 121.971 121.781L132.131 101" stroke="url(#paint2_linear_122_33)" strokeWidth="10" stroke-linecap="round"/>
      </g>
      <defs>
